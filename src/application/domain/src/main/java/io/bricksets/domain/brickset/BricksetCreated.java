...
public record BricksetCreated(EventId id, Timestamp occurredAt, Set<AggregateId> tags, BricksetId bricksetId, BricksetNumber number, BricksetTitle title) implements Event {
