...
public class Keys {
    ...
    public static final UniqueKey<BricksetViewRecord> UC_NUMBER = Internal.createUniqueKey(BricksetView.BRICKSET_VIEW, DSL.name("uc_number"), new TableField[] { BricksetView.BRICKSET_VIEW.NUMBER }, true);
